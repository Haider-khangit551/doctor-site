...
//         <div className="mt-20 px-4">
//             <Title title="Frequently Asked Questions" />
//             <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-lg shadow-md transition-colors duration-300">
//                 <h2 className="text-2xl sm:text-3xl mb-6 font-semibold text-gray-900 dark:text-gray-100">
//                     Questions & Answers
//                 </h2>
...
//                                 whileTap={{ scale: 0.98 }}
//                                 transition={{ type: "spring", stiffness: 200, damping: 15 }}
//                                 className="w-full text-left text-lg sm:text-xl flex justify-between items-center 
...
//                             {/* Answer expand karega sirf isi column ke andar */}
//                             <AnimatePresence initial={false}>
//                                 {activeIndex === q.id && (
//                                     <motion.div
//                                         key={q.id}
...
//                                             exit={{ x: -10, opacity: 0 }}
//                                             transition={{ duration: 0.3 }}
//                                             className="mt-2 text-gray-700 dark:text-gray-300 text-sm sm:text-base"
//                                         >
//                                             {q.answer}
//                                         </motion.p>
//                                     </motion.div>
