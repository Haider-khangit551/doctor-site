...
const ServiceCard = ({ service, index }) => {
    ...
    return (
        <motion.div
            ...
            <div className={`pointer-events-none blur-2xl rounded-full bg-gradient-to-r from-blue-500 via-indigo=500 to-purple-500  w-[300px] h-[300px] absolute z-0 transition-opacity duration-500 mix-blend-lighter ${visible ? 'opacity-70' : 'opacity-0'}`} style={{ top: position.y - 150, left: position.x - 150 }} />
            ...
            <div className='flex items-center gap-10 p-8 hover:p-7.5 hover:m-0.5 transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
                    ...
                    <div className='bg-gray-100 dark:bg-gray-700 rounded-full text-[#5044E5] p-4 flex items-center justify-center'>
                        {service.icon} {/* Render icon directly */}
                    </div>
                </div>
