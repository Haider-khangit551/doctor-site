...
//             {
//                 theme === "dark" ? <p className='text-white text-2xl'>HealthCare</p> : <p className='text-black text-2xl'>HealthCare</p>
//             }
...
//                 <img className='w-8 sm:hidden' src={theme === "dark" ? assets.menu_icon_dark : assets.menu_icon} onClick={() => setSideBarOpen(true)} alt="" />
