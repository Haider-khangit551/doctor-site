...
//     return (
//         <div className='fixed inset-0 flex items-center justify-center  h-[100vh] dark:bg-black bg-white'>
//             <div className='popup-from absolute mt-12 text-black shadow-gray-400 shadow-2xl border-1 rounded-md border-primary'>
//                 <form className='relative w-80 md:96 space-y-5 bg-white p-5 rounded-md'>
//                     <h1 className='text-3xl font-semibold text-gray-700 text-center'>Login</h1>
//                     <div className='flex flex-col'>
//                         <input
//                             type="text"
//                             placeholder='Enter Your First Name'
//                             className='py-3 px-3 bg-gray-100'
//                         />
//                     </div>
...
//                         <button className='bg-primary transition cursor-pointer text-white px-7 py-2 rounded-md'>Login</button>
//                         {/* <button className='bg-white text-red-600 px-7 rounded-md' onClick={closeModel}>Close</button> */}
//                     </div>

//                 </form>
//                 <button onClick={closeModel} className='absolute top-2 right-2 text-2xl cursor-pointer text-gray-700 hover:text-gray-900 duration'><IoIosClose /></button>
